...
import example.CodeStream.Companion.anilistAPI
import example.CodeStream.Companion.crunchyrollAPI
import example.CodeStream.Companion.filmxyAPI
import example.CodeStream.Companion.gdbot
import example.CodeStream.Companion.hdmovies4uAPI
import example.CodeStream.Companion.malsyncAPI
import example.CodeStream.Companion.tvMoviesAPI
import example.DumpUtils.queryApi
...
suspend fun extractMovieAPIlinks(serverid: String, movieid: String, movieAPI: String): String {
  val link = app.get("$movieAPI/ajax/get_stream_link?id=$serverid&movie=$movieid").document.toString()
...
object DumpUtils {
  ...
  private fun createHeaders(
    ...
    return mapOf(
      ...
      "sign" to getSign(currentTime, params),
