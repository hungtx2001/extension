...
import example.CodeExtractor.invokeAsianHD
import example.CodeExtractor.invokeAsiandrama
import example.CodeExtractor.invokeBollyflix
import example.CodeExtractor.invokeDahmerMovies
import example.CodeExtractor.invokeDoomovies
import example.CodeExtractor.invokeDotmovies
import example.CodeExtractor.invokeDramacool
...
import example.CodeExtractor.invokeFDMovies
...
import example.CodeExtractor.invokeHdmovies4u
...
import example.CodeExtractor.invokeMoviehubAPI
import example.CodeExtractor.invokeMoviesdrive
import example.CodeExtractor.invokeMoviesmod
import example.CodeExtractor.invokeMultiEmbed
...
import example.CodeExtractor.invokeNoverse
import example.CodeExtractor.invokeNowTv
import example.CodeExtractor.invokePlaydesi
import example.CodeExtractor.invokeRidomovies
import example.CodeExtractor.invokeShowflix
import example.CodeExtractor.invokeSmashyStream
import example.CodeExtractor.invokeTopMovies
import example.CodeExtractor.invokeTvMovies
import example.CodeExtractor.invokeUhdmovies
...
import example.CodeExtractor.invokeazseries
import example.CodeExtractor.invokekissasian
...
open class CodeStream : TmdbProvider() {
  ...
  override suspend fun load(url: String): LoadResponse? {
    ...
    val trailer =
      res.videos?.results?.filter { it.type == "Trailer" }?.map { "https://www.youtube.com/watch?v=${it.key}" }
        ?.reversed().orEmpty()
